            ...
            >
                <div className="flex items-center gap-3 px-6 h-20 border-b border-surface-100">
                    ...
                    <div className="flex flex-col">
                        <span className="font-display font-bold text-lg text-surface-900 leading-tight">Next Fit</span>
                        <span className="text-[10px] font-medium text-brand-600 tracking-wider uppercase">Análises de Atendimento</span>
                    </div>
                    <button
                        type="button"
                        onClick={onClose}
